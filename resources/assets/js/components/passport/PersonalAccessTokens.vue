            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0" v-if="tokens.length === 0">
                        No has creado ningún token de acceso personal.
                    </p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-danger" v-if="form.errors.length > 0">
                            <p class="mb-0"><strong>Whoops!</strong> Algop salio mal </p>
                            <br>
                            <ul>
                        ...
                        <form role="form" @submit.prevent="store">
                            ...
                            <div class="form-group row" v-if="scopes.length > 0">
                                <label class="col-md-4 col-form-label">Alcances</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            ...
                            Ahora puede utilizar este token para realizar solicitudes de API.
                        </p>
